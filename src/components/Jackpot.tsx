...
const neonPulse = keyframes`
  0% { 
    box-shadow: 0 0 24px #5964ff88, 0 0 48px #ffd70044;
    border-color: #00ff1544;
  }
  100% { 
    box-shadow: 0 0 48px #00ff0dcc, 0 0 96px #5993ff88;
    border-color: #00ff15aa;
  }
`;
...
const jackpotGlow = keyframes`
  0% { 
    box-shadow: 0 0 32px #00ff4088;
    transform: scale(1);
  }
  100% { 
    box-shadow: 0 0 64px #00ff0dcc, 0 0 96px #00ff00aa;
...
const Title = styled.h1`
  ...
  text-shadow: 0 0 16px #00ff0dff, 0 0 32px #15ff00ff;
  letter-spacing: 2px;
  position: relative;
  ...
  &::after {
    ...
    width: 180px;
    height: 3px;
    background: linear-gradient(90deg, transparent, #09ff00ff, #15ff00ff, #00ff0dff, transparent);
...
const JackpotAmount = styled.div`
  ...
  align-items: center;
  gap: 0.5rem;
  background: linear-gradient(135deg, rgba(0, 255, 34, 0.12), rgba(0, 255, 42, 0.08));
  border: 2px solid rgba(0, 255, 34, 0.3);
  border-radius: 14px;
  ...
  font-weight: 700;
  color: #00ff0dff;
  text-shadow: 0 0 8px #00ff0dff;
  box-shadow: 0 0 16px rgba(0, 255, 34, 0.18);
  ...
  &:hover {
    ...
    box-shadow: 0 0 24px rgba(0, 255, 34, 0.3);
    border-color: rgba(0, 255, 34, 0.6);
  }
...
const FeatureList = styled.ul`
  ...
  li {
    ...
    &::before {
      ...
      align-items: center;
      justify-content: center;
      box-shadow: 0 0 5px rgba(0, 255, 34, 0.18);
    }
  }
`
...
const Jackpot: React.FC<JackpotModalProps> = ({ onClose }) => {
            ...
            <ControlText style={{ alignItems: 'center', textAlign: 'center' }}>
              ...
              <ControlSubtitle>
                {context.defaultJackpotFee === 0
                    ? "Disabled – you won't contribute to or win the jackpot"
                    : "Enabled – you contribute and can win the jackpot"}
              </ControlSubtitle>
            </ControlText>
